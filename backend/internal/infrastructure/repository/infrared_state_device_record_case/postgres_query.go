...
func (p *postgresImpl) queryReadListBySessionId(sessionId uuid.UUID) (query string, args []any, err error) {
...
func (p *postgresImpl) queryReadListStatesByCaseId(caseId uuid.UUID) (query string, args []any, err error) {
...
func (p *postgresImpl) queryReadListRawByCaseId(caseId uuid.UUID) (query string, args []any, err error) {
...
func (p *postgresImpl) queryReadRawById(rawId uuid.UUID) (query string, args []any, err error) {
	return p.SqrD.Select(infraredRecordRawColumns...).
		From("infrared_state_device_record_raw").
