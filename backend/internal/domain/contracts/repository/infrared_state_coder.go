...
type InfraredStateCoder interface {
	...
	ReadBySessionId(ctx context.Context, sessionId uuid.UUID) (*domainmodels.InfraredStateCoder, error)
	ReadById(ctx context.Context, id uuid.UUID) (*domainmodels.InfraredStateCoder, error)
