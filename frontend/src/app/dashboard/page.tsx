...
export default async function DashboardPage() {
  ...
  return (
    <div className="bg-background flex min-h-screen flex-col">
      <header className="border-ink/10 bg-surface flex items-center justify-between gap-4 border-b px-6 py-4 sm:px-10">
        <div className="flex items-center gap-3">
          <Image src={hat} alt="" className="h-8 w-8 sm:h-9 sm:w-9" />
          <div>
            <p className="font-display text-primary text-lg tracking-wide sm:text-xl">
              Dashboard
            </p>
